...
public class FabricaSale {
    public Sale crear(ComandoSale comandoSale){
        return new Sale(comandoSale.getSaleId(), comandoSale.getClientId(), comandoSale.isActive(), comandoSale.getPurchaseValue(), comandoSale.getCreationDate(), comandoSale.getDiscountPercentage(), comandoSale.getClient(), comandoSale.getSaleProducts());
    }
}
